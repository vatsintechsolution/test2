    ...
    try {
      ...
      if (containerRef.current && canvasRef.current) {
        ...
        const modelPath = process.env.NODE_ENV === 'production' 
          ? 'https://fans.ecolinklighting.in/models/airoelevate.glb'
          : '/models/airoelevate.glb';
        ...
        loader.load(
          ...
          (err) => {
            ...
            if (modelLoadAttempts < 3) {
              ...
              if (modelLoadAttempts === 1) retryPath = '/models/airoelevate.glb';
              if (modelLoadAttempts === 2) retryPath = 'https://raw.githubusercontent.com/ecolinklighting/fans/main/public/models/airoelevate.glb';
